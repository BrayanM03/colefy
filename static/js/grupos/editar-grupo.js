const Toast = Swal.mixin({
  ...
  function reloadTable(){ 
    ...
    const columns = [
      ...
      }},
      {
        data: null, title: 'Opciones', render: function (data, type, row) {
          ...
          <div class='row'>
            <div class='col-12 col-md-12'>
              <div class="btn btn-warning btn-desactivar">
    ...
    DataTableListener(table, 'click', '.btn-desactivar', desactivarAlumnoGrupo)
  ...
  function actualizarGrupo(){
    ...
    function cancelarAlumnoGrupo(id_registro){
        Swal.fire({
            icon: 'question',
            title: '¿Deseas eliminar definitivamente a este alumno? Ya no se podrá reactivar',
    ...
    function desactivarAlumnoGrupo(id_registro){
      Swal.fire({
          icon: 'question',
          ...
          if(r.isConfirmed){
              $.ajax({
                  type: "post",
                  url: BASE_URL + "api/grupos.php?tipo=desactivar_alumno_grupo",
                  data: {id_registro},
                  dataType: "json",
                  success: function (response) {
                    table.ajax.reload(null, false)

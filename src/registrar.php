...
<head>
	...
	<title>Registrar usuario |ERP Manager</title>
								...
								<div class="m-sm-4">
									<form>
										...
										<div class="mb-3">
											...
											<input class="form-control form-control-lg animate__animated" type="password" id="pass" name="password" placeholder="Ingresa una contraseña" autocomplete="new-password" />
										</div>
										<div class="mb-3">
											<label class="form-label">Sucursal</label>
											<select name="" onchange="setearProyecto()" class="form-control animate__animated"id="sucursal">
										...
										<div class="mb-3">
											...
											<select name="" class="form-control animate__animated" id="project">
											</select>
										</div>

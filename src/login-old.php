...
<body style="background-image: url(<?php echo STATIC_URL; ?>img/background_2.jpg); overflow-y: hidden; background-size:cover; backdrop-filter: blur(3px);">
							...
							<div class="card-body">
								<div class="m-sm-4">
									<div class="text-center">
										<img src="<?php echo STATIC_URL; ?>img/logo.png" alt="Charles Hall" class="img-fluid" width="180" height="150" />
									</div>
									<form>
										<div class="mb-3">
